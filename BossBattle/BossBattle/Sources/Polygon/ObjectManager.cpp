...
void ObjectManager::SstModelMap(ID3D11Device* pDevice,std::string keyName)
{
...
void ObjectManager::SstSpriteMap(ID3D11Device* pDevice, std::wstring keyName)
{
...
void ObjectManager::SstModelShader(ID3D11Device* pDevice, std::wstring keyName)
{
...
void ObjectManager::SstSpriteShader(ID3D11Device* pDevice, std::wstring keyName)
{
